...
from utils.locators import YandexPageLocator, YaScooterHomePageLocator
...
class TestYaScooterHomePage:
    ...
    def test_click_yandex_button_go_to_yandex(self, driver):
        ...
        ya_scooter_home_page.find_element(YandexPageLocator.DOWNLOAD_BUTTON, 3)     # На странице Яндекса всплывает об установке Яндекс.Браузера, ждем его
    ...
    def test_faq_click_first_question_show_answer(self, driver):
        ...
        ya_scooter_home_page.go_to_site()
        ya_scooter_home_page.click_cookie_accept()
        ya_scooter_home_page.click_faq_question(0)
